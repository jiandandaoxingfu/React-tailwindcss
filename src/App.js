  ...
  return (
    <div>
      ...
      <div className="container flex flex-row h-screen w-screen mx-auto border-2 rounded-xl overflow-hidden">
        {/*LeftPanel*/}
        <div className="flex flex-col h-full w-1/5 min-w-max bg-gray-600 justify-between">
          {/* Header */}
          ...
          {/* Menu */}
          <div className="ml-3 overflow-y-auto space-y-6 flex-grow">
            {
      ...
      <div className="container mt-10 flex flex-col items-center gap-4 w-screen mx-auto border-2 rounded-xl">
        ...
        <div className="alert alert-success shadow-lg w-2/3">
          <div>
        ...
        <div className="tabs">
          <a href="/#" className="tab tab-lifted tab-active">Tab 1</a>
          <a href="/#" className="tab tab-lifted">Tab 2</a>
          <a href="/#" className="tab tab-lifted">Tab 3</a>
        </div>
